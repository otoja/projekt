...
class newVisitForm extends createForm {
    ...
    public function __construct($action, $method) {
        ...
        $widow="onClick=\"javascript:window.open('/Final/forms/addBadForm.php','Wyniki badan','width=500,height=600,toolbar=no,menubar=no')\" class=button";
        $this->addInput("wynbad", "button", "Wyniki badań", "", "", $widow);
        $widow="onClick=\"javascript:window.open('/Final/forms/addReceptaForm.php','Recepta','width=300,height=500')\" class=button";
        $this->addInput("rec", "button", "Recepta", "", "", $widow);
        $widow="onClick=\"javascript:window.open('/Final/forms/addSkierForm.php','Skierowanie','width=300,height=500')\" class=button";
        $this->addInput("skier", "button", "Skierowanie", "<br>", "", $widow);
        $widow="onClick=\"javascript:window.open('/Final/mod/modEpr.php?type=showEpr','Dotychczasowa historia choroby','width=300,height=500')\" class=button";
